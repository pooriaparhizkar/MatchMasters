...
public class spawnGems : MonoBehaviour
{
    ...
    private gemColors[,] template1 = new gemColors[7, 7] { {gemColors.yellow, gemColors.orange,gemColors.blue,gemColors.yellow,gemColors.orange,gemColors.red,gemColors.orange },
        {gemColors.green,gemColors.purple,gemColors.orange,gemColors.red,gemColors.orange,gemColors.blue,gemColors.red},
        {gemColors.orange,gemColors.red,gemColors.purple,gemColors.blue,gemColors.green,gemColors.purple,gemColors.blue},
        {gemColors.red,gemColors.yellow,gemColors.purple,gemColors.blue,gemColors.yellow,gemColors.purple,gemColors.orange},
        {gemColors.red,gemColors.purple,gemColors.green,gemColors.purple,gemColors.green,gemColors.yellow,gemColors.purple},
        {gemColors.orange,gemColors.blue,gemColors.red,gemColors.yellow,gemColors.orange,gemColors.green,gemColors.red},
        {gemColors.purple,gemColors.green,gemColors.yellow,gemColors.blue,gemColors.yellow,gemColors.blue,gemColors.yellow} };
